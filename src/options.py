...
class TrainShapeMatchingOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--step1_epochs', type=int, default=0, help='epoch number of training G_S on the max scale {1}')
        self.parser.add_argument('--step2_epochs', type=int, default=0, help='epoch number of training G_S on the two extreme scales {0, 1}') 
        self.parser.add_argument('--step3_epochs', type=int, default=0, help='epoch number of training G_S on the full scales')     
        self.parser.add_argument('--step4_epochs', type=int, default=1, help='epoch number of training G_S with glyph loss')
        ...
        self.parser.add_argument('--glyph_preserve', action='store_true', default=True, help='Whether using glyph loss to preserve the text legibility')        
